...
class SSLMetaArch(nn.Module):
    def __init__(self, cfg):
        ...
        if cfg.student.pretrained_weights:
            ...
            # CUSTOM WEIGHTS LOADING (TODO)
            # load_result = student_backbone.load_state_dict(chkpt["model"], strict=True)
            # logger.info(f"[SSLMetaArch/EDO] Missing keys: {load_result.missing_keys}")
            # logger.info(f"[SSLMetaArch/EDO] Unexpected keys: {load_result.unexpected_keys}")
