...
def run_eval_linear(
    ...
    print("#" * 100)
    print("Number of labels:", len(train_dataset.get_targets()))
    print("Min label:", train_dataset.get_targets().min())
    print("Max label:", train_dataset.get_targets().max())
    print("Unique labels:", np.unique(train_dataset.get_targets()))
    print("\n\nTrain num classes:", training_num_classes)
    print("#" * 100)
